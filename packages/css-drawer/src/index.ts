...
// when consumers don't reach it via the named exports. Calling it from the
// whitelisted entry guarantees scrollLock, the `inert` z-index manager,
// and the `drawer:statechange` event always work, regardless of which
// drawer APIs the consumer ends up using.
initDrawerObserver()
